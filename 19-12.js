...
/*
    19-1 When to use a function, use function inside a loop (take an array and double it, separate even and odd number from an array, make a multiplication table (নামতা), Double only even number, //If else একটা function এ নিয়ে forloop এর মধ্যেও function call করা যায়।  )
